        ...
        <div className="p-6">
          ...
          {projection &&
            ...
            projection.gapToDistinguished.members > 0 && (
              <div className="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg shadow-sm p-4">
                <h4 className="font-semibold text-yellow-900 mb-3 flex items-center gap-2 font-tm-headline">
                  <svg
                ...
                <p className="text-yellow-800 font-tm-body text-sm">
