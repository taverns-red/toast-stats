...
date: 2026-06-10
tier: lesson
summary: Live-verify a pipeline-gated CDN artifact by injecting the REAL locally-built artifact via route interception (and drive the missing-artifact path un-injected)
